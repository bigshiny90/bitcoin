...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-blockreconstructionextratxnsize=<MB>",
                   strprintf("Upper limit of memory usage (in megabytes) for keeping extra transactions in memory for compact block reconstructions (default: unlimited)"),
                   ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
